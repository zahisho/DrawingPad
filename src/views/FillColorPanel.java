 ...
 * @author M16U3L
 */
public class FillColorPanel extends JPanel implements ActionListener {
  ...
  public FillColorPanel(ScribbleCanvas panelCanvas) {
    this.panelCanvas = panelCanvas;
    setLayout(new BorderLayout());

    JLabel titleChooseColor = new JLabel("FILL");
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (source == okButton) {
      panelCanvas.setFillColor(colorPanel.getColor());
      result = colorPanel.getColor();
      panelCanvas.changeFillSelectedShapes();
    } else if (source == moreColorButton) {
      Color selectedColor = JColorChooser.showDialog(FillColorPanel.this,
        "Choose color", color);
